...
from Kembalikankomik import Kembalikankomik
# pip install tkcalendar
from tkcalendar import Calendar, DateEntry 

class FormKembalikankomik:   
    def __init__(self, parent):
        self.parent = parent       
        self.parent.geometry("450x450")
        self.parent.title(Kembalikankomik)
    ...
    def aturKomponen(self):
        ...
        # date 
        Label(mainFrame, text='TANGGAL_DIKEMBALIKAN:').grid(row=3, column=0, sticky=W, padx=5, pady=5)
        # Date Input TANGGAL_DIKEMBALIKAN
        self.txtTANGGAL_DIKEMBALIKAN = DateEntry(mainFrame, width= 16, background= "magenta3", foreground= "white",bd=2, date_pattern='y-mm-dd') 
        self.txtTANGGAL_DIKEMBALIKAN.grid(row=3, column=1, padx=5, pady=5)
        ...
        # define columns
        columns = ('Id','Nama_Konsumen','Judul_Komik','Jumlah_Komik','Tanggal_Dikembalikan','Tarif_PerHari','Total_Bayar','Status_Bayar')
        ...
        self.tree.heading('Tanggal_Dikembalikan', text='Tanggal_Dikembalikan')
        self.tree.column('Tanggal_Dikembalikan', width="100")
    ...
    def TampilkanData(self, event=None):
        ...
        self.txtTANGGAL_DIKEMBALIKAN.delete(0,END)
        self.txtTANGGAL_DIKEMBALIKAN.insert(END,obj.Tanggal_Dikembalikan)
    ...
    def onSimpan(self, event=None):
        ...
        Tanggal_Dikembalikan = self.txtTANGGAL_DIKEMBALIKAN.get()
        ...
        obj.Tanggal_Dikembalikan = Tanggal_Dikembalikan
...
if __name__ == '__main__':
    root = tk.Tk()
    aplikasi = FormKembalikankomik(root)
    root.mainloop() 
